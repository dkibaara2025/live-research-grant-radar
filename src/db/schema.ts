...
export const teamMembers = pgTable(
  "team_members",
  {
    ...
    preferredRole: text("preferred_role").default("Other").notNull(),
    ...
    expertiseKeywords: jsonb("expertise_keywords").$type<string[]>().default([]).notNull(),
    domainExpertise: jsonb("domain_expertise").$type<string[]>().default([]).notNull(),
    methodsExpertise: jsonb("methods_expertise").$type<string[]>().default([]).notNull(),
    geographicExperience: jsonb("geographic_experience").$type<string[]>().default([]).notNull(),
    ...
    selectedPublications: jsonb("selected_publications").$type<string[]>().default([]).notNull(),
